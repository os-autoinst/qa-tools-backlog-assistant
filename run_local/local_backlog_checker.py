...
def initialize_md():
    print("Start Loging ...\nInitialize \"index.md\" ")
    # for local run initail alway write new 'index.md' file
...
def gha_overall():
    ...
    answer = requests.get("https://progress.opensuse.org/issues.json?query_id=230&")
...
if __name__ == "__main__":
    # setup key or set blank
    os.environ['key'] = ''

    # intial index.md file
    initialize_md()
